...
const (
	ProductService_CreateProduct_FullMethodName = "/prod.ProductService/CreateProduct"
	ProductService_GetProduct_FullMethodName    = "/prod.ProductService/GetProduct"
	ProductService_UpdateProduct_FullMethodName = "/prod.ProductService/UpdateProduct"
	ProductService_DeleteProduct_FullMethodName = "/prod.ProductService/DeleteProduct"
	ProductService_CreateReview_FullMethodName  = "/prod.ProductService/CreateReview"
	ProductService_DeleteReview_FullMethodName  = "/prod.ProductService/DeleteReview"
)
...
func (c *productServiceClient) CreateReview(ctx context.Context, in *CreateReviewRequest, opts ...grpc.CallOption) (*CreateReviewResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductService_CreateReview_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) DeleteReview(ctx context.Context, in *DeleteReviewRequest, opts ...grpc.CallOption) (*DeleteReviewResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductService_DeleteReview_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
